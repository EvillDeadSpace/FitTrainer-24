...
const ServicesCard = ({ item, index }) => {
  ...
  return (
    <div className="py-[30px] px-3 lg:px-5 ">
      <h2 className=" text-[26px]  leading-9    text-accentColor font-[700] ">
        {title}
      </h2>
      ...
      <div className="flex  items-center  justify-between mt-[30px]">
        <Link
          to="/coach"
          className="w-[44px] h-[44px]   rounded-full border  border-solid border-black  flex  items-center justify-center group  hover:bg-primaryColor hover:border-none"
        >
          {" "}
